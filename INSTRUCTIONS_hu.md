...
* {ICON:quick_play} **Gyors lejátszás (minilejátszó)**: Elindítja az utolsó 30 perc nézetablakban történő archív lejátszását, lehetővé téve a legutóbbi felvételek gyors áttekintését közvetlenül a kameralapon, anélkül, hogy elhagyná az Élő nézetet.
...
* **Többmonitoros és kiegészítő ablakok**: Megnyithat független további (kiegészítő) ablakokat, hogy különböző rácselrendezéseket futtasson egyszerre több képernyőn vagy monitoron. Új ablak megnyitásához használja a `Ctrl+N` billentyűparancsot, vagy kattintson az **"Új ablak"** gombra a csúsztatható felső eszköztáron. Minden ablak konfigurálható saját rácsmérettel és kiválasztott előre beállított elrendezéssel. A többmonitoros konfigurációk maximális stabilitása érdekében az összes ablak szigorúan az elsődleges kijelző közepén indul el, annak felbontásának 90%-án.

### Nézetablak átfedő gombjai
Az egyes kameralapok/nézeti ablakok jobb alsó sarkában egy vezérlőpult jelenik meg öt funkcionális ikonnal, amikor az egérmutatót fölé viszi (a felhasználói felület beállításaitól függően):
...
3. **Kör alakú nyíl ikon (Gyors lejátszás / Minilejátszó)**: Aktiválja a kamera archív felvételeinek gyors, nézetablakban történő lejátszását az elmúlt 30 percből közvetlenül a kameralapon belül anélkül, hogy elhagyná az élő rácsot vagy megnyitná a teljes archívum ablakot.
   * **Vezérlőpult**: Ha aktív, egy csúszó vezérlőpanel jelenik meg a nézetablak alján, amely a következőket tartalmazza:
     * **Lejátszás/Szünet**: Szünetelteti vagy folytatja a lejátszási adatfolyamot.
     * **Idő és eltolás kijelzése**: Megjeleníti az aktuális lejátszási időbélyeget és annak relatív korát a valós időhöz képest (például a `-12:34` 12 perc 34 másodpercet jelent).
     * **Interaktív idővonal csúszka**: Kattintással vagy húzással bárhová kereshet a 30 perces pufferen belül. Az elérhető felvételi szegmensek kékeszöld háttérrel vannak kiemelve, és egy piros lejátszófej jelzi az aktuális pozíciót.
     * **Sebességszorzó**: A lejátszási sebességek között (`1x`, `2x` és `4x`) váltakozik a felvételek gyors beolvasásához.
     * **Bezárás (✕)**: Bezárja a minilejátszót, és azonnal visszaállítja a nézetablakot az élő hírfolyamhoz.
   * **Pásztázható nagyítás támogatása**: Akárcsak az Élő nézetben, a nagyító eszközzel is ráközelíthet egy területre a minilejátszóban, vagy tartsa lenyomva a középső egérgombot és húzza a pásztázáshoz.
4. **1:1 ikon (Natív méretarány)**: Képpontok közötti videomegjelenítési mód váltása. Ha engedélyezve van, a videó nem nyúlik meg vagy torzul, hogy kitöltse a csempe határait, hanem középre kerül, és az eredeti natív felbontásban jelenik meg. Ha ez a mód aktív, a gomb háttere és az „1:1” szöveg világos neon világos-türkiz színnel kiemelve.
5. **Nagyítóikon (Interaktív zoom)**: Lehetővé teszi a videó feed bármely meghatározott részének nagyítását:
   ...
   * **Művelet**: Kattintson a bal gombbal, és húzzon egy téglalap alakú kijelölő területet az élő hírfolyam fölé. A nézetablak automatikusan levágja és átméretezi a kiválasztott területet, hogy kitöltse a teljes csempét.
     * **Arányos nagyítás**: Tartsa lenyomva a **Shift** billentyűt a nagyítási téglalap rajzolása közben, hogy a kijelölést 16:9-es képarányra kényszerítse, szigorúan a nézetablak határaihoz kötötten.
     * **A nagyított kép pásztázása (Pan Zoom)**: A nagyítás után tartsa lenyomva a **középső egérgombot (görgőt)**, és húzza a kurzort a nagyított nézet szabadon pásztázásához a videó látómezője körül. Ez élő nézetben, lejátszási archívumban és minilejátszóban működik.
...
| **Shift** (húzó kijelölő) | Kényszerítse a kijelölőt, hogy rögzítse a 16:9-es képarányt az interaktív zoom során. |
...
* **Középső egérgomb (görgőgomb kattintás és húzás)**:
  * Húzza a pásztázáshoz és mozgassa a digitálisan nagyított/nagyított képet a nézetablak látómezője körül (élő, archív és minilejátszóban működik).
