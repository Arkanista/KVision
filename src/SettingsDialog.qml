...
Dialog {
    ...
    function loadSettings() {
        ...
        topBarAutoCollapseCheckBox.checked = rootWindowSettings.topBarAutoCollapse;
    ...
    function saveSettings() {
        ...
        rootWindowSettings.topBarAutoCollapse = topBarAutoCollapseCheckBox.checked;
