...
* **[Download kvision-2.2.7-4-x86_64.pkg.tar.zst](https://github.com/Arkanista/kvision/releases/download/v2.2.7/kvision-2.2.7-4-x86_64.pkg.tar.zst)**

To install the downloaded package:
```bash
sudo pacman -U kvision-2.2.7-4-x86_64.pkg.tar.zst
```
