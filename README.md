...
* **[Download kvision-2.4.2-1-x86_64.pkg.tar.zst](https://github.com/Arkanista/KVision/releases/download/v2.4.2/kvision-2.4.2-1-x86_64.pkg.tar.zst)**

To install the downloaded package:
```bash
sudo pacman -U kvision-2.4.2-1-x86_64.pkg.tar.zst
```
