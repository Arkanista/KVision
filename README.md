...
* **[Download kvision-2.2.8-2-x86_64.pkg.tar.zst](https://github.com/Arkanista/kvision/releases/download/v2.2.8-2/kvision-2.2.8-2-x86_64.pkg.tar.zst)**

To install the downloaded package:
```bash
sudo pacman -U kvision-2.2.8-2-x86_64.pkg.tar.zst
```
